...
class CreateCategoryCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            //the short description show while running "php bin/console list"
    ...
    {
        //output multiple lines to the console (adding "\n" the end of each line)
        $output->writeln([
            'Category Creator',
            '================',
            '',
        ...
        $output->writeln('create a category');

        //retrive the argument value using getArgument
